...
namespace WalletApi.Migrations
{
    ...
    [Migration("20220331213202_Added_Staff_And_Address_Table")]
    partial class Added_Staff_And_Address_Table
    {
            ...
            modelBuilder.Entity("Wallet.Entities.Models.Domain.AirTime", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2022, 3, 31, 22, 32, 1, 519, DateTimeKind.Local).AddTicks(3537),
                            NetworkProvider = "Mtn",
                            UpdatedAt = new DateTime(2022, 3, 31, 22, 32, 1, 519, DateTimeKind.Local).AddTicks(3881)
                        },
                        new
                        {
                            Id = new Guid("d584f98c-4a22-482d-bc9e-c1899aedcc57"),
                            CreatedAt = new DateTime(2022, 3, 31, 22, 32, 1, 519, DateTimeKind.Local).AddTicks(4126),
                            NetworkProvider = "Airtel",
                            UpdatedAt = new DateTime(2022, 3, 31, 22, 32, 1, 519, DateTimeKind.Local).AddTicks(4129)
                        });
                });
            ...
            modelBuilder.Entity("Wallet.Entities.Models.Domain.Bill", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Amount = 6500m,
                            BillName = "DSTV",
                            CreatedAt = new DateTime(2022, 3, 31, 22, 32, 1, 520, DateTimeKind.Local).AddTicks(1387),
                            UpdatedAt = new DateTime(2022, 3, 31, 22, 32, 1, 520, DateTimeKind.Local).AddTicks(1610)
                        },
                        new
                        {
                            ...
                            Amount = 3000m,
                            BillName = "GOTV",
                            CreatedAt = new DateTime(2022, 3, 31, 22, 32, 1, 520, DateTimeKind.Local).AddTicks(1821),
                            UpdatedAt = new DateTime(2022, 3, 31, 22, 32, 1, 520, DateTimeKind.Local).AddTicks(1823)
                        });
                });
            ...
            modelBuilder.Entity("Wallet.Entities.Models.Domain.Data", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2022, 3, 31, 22, 32, 1, 519, DateTimeKind.Local).AddTicks(7387),
                            NetworkProvider = "Mtn",
                            UpdatedAt = new DateTime(2022, 3, 31, 22, 32, 1, 519, DateTimeKind.Local).AddTicks(7662)
                        },
                        new
                        {
                            Id = new Guid("9806f26b-e013-4dff-812a-afba47d2fbe0"),
                            CreatedAt = new DateTime(2022, 3, 31, 22, 32, 1, 519, DateTimeKind.Local).AddTicks(7925),
                            NetworkProvider = "Airtel",
                            UpdatedAt = new DateTime(2022, 3, 31, 22, 32, 1, 519, DateTimeKind.Local).AddTicks(7927)
                        });
                });
            ...
            modelBuilder.Entity("Wallet.Entities.Models.Domain.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "b716d882-afeb-4609-a5ca-e05baeb3386e",
                            ConcurrencyStamp = "2c790b34-9672-44be-af88-e7e8b7c24c89",
                            CreatedAt = new DateTime(2022, 3, 31, 22, 32, 1, 517, DateTimeKind.Local).AddTicks(9060),
                            Name = "Admin",
                            NormalizedName = "ADMIN",
                            UpdatedAt = new DateTime(2022, 3, 31, 22, 32, 1, 517, DateTimeKind.Local).AddTicks(9462)
                        },
                        new
                        {
                            Id = "7a94c00e-b0db-4c09-85a0-d816133b4ac6",
                            ConcurrencyStamp = "7c3187e3-8095-4dc5-af54-05425494f6d4",
                            CreatedAt = new DateTime(2022, 3, 31, 22, 32, 1, 517, DateTimeKind.Local).AddTicks(9766),
                            Name = "Manager",
                            NormalizedName = "MANAGER",
                            UpdatedAt = new DateTime(2022, 3, 31, 22, 32, 1, 517, DateTimeKind.Local).AddTicks(9768)
                        });
                });
