...
namespace WalletApi.Migrations
{
    ...
    [Migration("20220331203608_Removed_FullName_from_User_Table")]
    partial class Removed_FullName_from_User_Table
    {
            ...
            modelBuilder.Entity("Wallet.Entities.Models.Domain.AirTime", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2022, 3, 31, 21, 36, 7, 604, DateTimeKind.Local).AddTicks(3883),
                            NetworkProvider = "Mtn",
                            UpdatedAt = new DateTime(2022, 3, 31, 21, 36, 7, 604, DateTimeKind.Local).AddTicks(4064)
                        },
                        new
                        {
                            Id = new Guid("d584f98c-4a22-482d-bc9e-c1899aedcc57"),
                            CreatedAt = new DateTime(2022, 3, 31, 21, 36, 7, 604, DateTimeKind.Local).AddTicks(4223),
                            NetworkProvider = "Airtel",
                            UpdatedAt = new DateTime(2022, 3, 31, 21, 36, 7, 604, DateTimeKind.Local).AddTicks(4224)
                        });
                });
            ...
            modelBuilder.Entity("Wallet.Entities.Models.Domain.Bill", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Amount = 6500m,
                            BillName = "DSTV",
                            CreatedAt = new DateTime(2022, 3, 31, 21, 36, 7, 604, DateTimeKind.Local).AddTicks(9462),
                            UpdatedAt = new DateTime(2022, 3, 31, 21, 36, 7, 604, DateTimeKind.Local).AddTicks(9650)
                        },
                        new
                        {
                            ...
                            Amount = 3000m,
                            BillName = "GOTV",
                            CreatedAt = new DateTime(2022, 3, 31, 21, 36, 7, 604, DateTimeKind.Local).AddTicks(9806),
                            UpdatedAt = new DateTime(2022, 3, 31, 21, 36, 7, 604, DateTimeKind.Local).AddTicks(9807)
                        });
                });
            ...
            modelBuilder.Entity("Wallet.Entities.Models.Domain.Data", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2022, 3, 31, 21, 36, 7, 604, DateTimeKind.Local).AddTicks(6760),
                            NetworkProvider = "Mtn",
                            UpdatedAt = new DateTime(2022, 3, 31, 21, 36, 7, 604, DateTimeKind.Local).AddTicks(6919)
                        },
                        new
                        {
                            Id = new Guid("9806f26b-e013-4dff-812a-afba47d2fbe0"),
                            CreatedAt = new DateTime(2022, 3, 31, 21, 36, 7, 604, DateTimeKind.Local).AddTicks(7072),
                            NetworkProvider = "Airtel",
                            UpdatedAt = new DateTime(2022, 3, 31, 21, 36, 7, 604, DateTimeKind.Local).AddTicks(7073)
                        });
                });
            ...
            modelBuilder.Entity("Wallet.Entities.Models.Domain.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "ea103df2-d931-439a-ad99-6564bf05d0fd",
                            ConcurrencyStamp = "bffba74c-3993-434b-88ba-0ee44d0fafd2",
                            CreatedAt = new DateTime(2022, 3, 31, 21, 36, 7, 603, DateTimeKind.Local).AddTicks(4339),
                            Name = "Admin",
                            NormalizedName = "ADMIN",
                            UpdatedAt = new DateTime(2022, 3, 31, 21, 36, 7, 603, DateTimeKind.Local).AddTicks(4658)
                        },
                        new
                        {
                            Id = "1048213a-f434-46d4-be70-f7cf7280cd45",
                            ConcurrencyStamp = "74bb73b6-4952-44f4-ba64-0a7785322f1a",
                            CreatedAt = new DateTime(2022, 3, 31, 21, 36, 7, 603, DateTimeKind.Local).AddTicks(4907),
                            Name = "Manager",
                            NormalizedName = "MANAGER",
                            UpdatedAt = new DateTime(2022, 3, 31, 21, 36, 7, 603, DateTimeKind.Local).AddTicks(4909)
                        });
                });
