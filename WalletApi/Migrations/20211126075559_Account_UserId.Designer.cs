...
namespace WalletApi.Migrations
{
    ...
    [Migration("20211126075559_Account_UserId")]
    partial class Account_UserId
    {
            ...
            modelBuilder.Entity("Wallet.Entities.Models.Domain.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "a3fefc71-e7bf-4976-9c78-8ba7ad9e30c6",
                            ConcurrencyStamp = "4c17bfcd-9d18-4378-9087-f59572147141",
                            CreatedAt = new DateTime(2021, 11, 26, 8, 55, 56, 837, DateTimeKind.Local).AddTicks(251),
                            Name = "Admin",
                            NormalizedName = "ADMIN",
                            UpdatedAt = new DateTime(2021, 11, 26, 8, 55, 56, 837, DateTimeKind.Local).AddTicks(1393)
                        },
                        new
                        {
                            Id = "f7c518d4-e6bf-4a75-87a8-c674b31b3576",
                            ConcurrencyStamp = "e3a0686f-4a3f-4bd0-aa93-8d6995042602",
                            CreatedAt = new DateTime(2021, 11, 26, 8, 55, 56, 837, DateTimeKind.Local).AddTicks(3016),
                            Name = "Manager",
                            NormalizedName = "MANAGER",
                            UpdatedAt = new DateTime(2021, 11, 26, 8, 55, 56, 837, DateTimeKind.Local).AddTicks(3038)
                        });
                });
